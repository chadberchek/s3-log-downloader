...
describe('S3 log parser', () => {
    it('parses fields and converts dash to null', () => {
    ...
    it('sets query string to null if no query string present', () => {
    ...
    it('parses static web access entry', () => {
    ...
    it('parses error code and version ID fields', () => {
    ...
    it('treats missing bytes sent field as 0', () => {
    ...
    it('parses multiple lines as individual entries with LF or CRLF line ending', () => {
    ...
    it('omits HTTP method, HTTP version, path name, and query string if request URI is absent', () => {
    ...
    it('sets date to null if absent', () => {
    ...
    it('throws excpetion if line format does not match spec', () => {
    ...
    it('throws exception if time format is invalid', () => {
    ...
    it('throws exception if request URI does not have 3 space delimited parts', () => {
    ...
    it('throws exception if number cannot be parsed', () => {
